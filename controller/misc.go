...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"support_qrcode_url":          operation_setting.GetGeneralSetting().SupportQRCodeURL,
		"support_qrcode_description":  operation_setting.GetGeneralSetting().SupportQRCodeDescription,
