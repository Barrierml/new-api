...
func InitOptionMap() {
	...
	common.OptionMap["CatfkEnabled"] = strconv.FormatBool(setting.CatfkEnabled)
	...
	common.OptionMap["GlobalModelMappingGroups"] = "[]"
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "CatfkEnabled":
		setting.CatfkEnabled = value == "true"
	case "CatfkMerchantUser":
		setting.CatfkMerchantUser = value
	case "CatfkMerchantPass":
	...
	case "GlobalModelMappingGroups":
		err = ratio_setting.UpdateGlobalModelMappingGroupsByJSONString(value)
	case "GroupRatio":
