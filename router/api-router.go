	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/checkout", middleware.CriticalRateLimit(), controller.CreateCheckout)
				selfRoute.GET("/checkout/status", controller.CheckoutStatus)
				selfRoute.GET("/orders", controller.ListMyCatfkOrders)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/bind/batch", controller.AdminBindSubscriptionBatch)
			...
			subscriptionAdminRoute.POST("/user_subscriptions/:id/reset_sub_quota", controller.AdminResetUserSubscriptionSubQuota)
		...
		operationsRoute.GET("/overview", middleware.AdminAuth(), controller.GetOperationsOverview)
