...
import { AppWindow, ArrowRight, BookOpen, Terminal } from 'lucide-react'
          ...
          >
            <div className='mb-4 flex flex-col gap-1'>
              <span className='text-muted-foreground/50 text-[10px] font-bold tracking-[0.15em] uppercase'>
                {t('Official Open-Source Tools')}
              </span>
              <p className='text-muted-foreground/60 text-xs leading-relaxed'>
                {t(
                  'Built by the Tako team — one-click setup, pre-configured for this gateway.'
                )}
              </p>
            </div>
            <div className='flex flex-wrap items-center gap-3'>
              {/* tako-cli */}
              <a
                href='https://github.com/tako-dev/cli'
                target='_blank'
                rel='noopener noreferrer'
                className='group border-border/40 bg-muted/15 text-foreground/80 hover:border-border hover:bg-muted/30 hover:text-foreground flex items-center gap-3 rounded-full border px-5 py-2.5 text-sm font-medium shadow-[0_1px_2.5px_rgba(0,0,0,0.01)] backdrop-blur-xs transition-all duration-300 hover:scale-[1.02]'
              >
                <Terminal className='size-5 shrink-0 text-orange-500' />
                <span>tako-cli</span>
              </a>
              ...
              <a
                ...
                className='group border-border/40 bg-muted/15 text-foreground/80 hover:border-border hover:bg-muted/30 hover:text-foreground flex items-center gap-3 rounded-full border px-5 py-2.5 text-sm font-medium shadow-[0_1px_2.5px_rgba(0,0,0,0.01)] backdrop-blur-xs transition-all duration-300 hover:scale-[1.02]'
              >
                <AppWindow className='size-5 shrink-0 text-orange-500' />
              ...
              <Link
                to='/docs/$'
                params={{ _splat: 'integrations/openai-compat' }}
